    ...
    <div class="container">
        <section id="content">
            <form name="Registration" action="Controller" method="POST">
                ...
                <div>
                    <input class="userdata" id="username" type="text" name="login" pattern="^[a-z0-9-_]{3,15}$"
                           placeholder="<fmt:message key="label.registration.login"/>*" autofocus required/>
                </div>
                <div>
                    <input class="userdata" id="fname" type="text" name="firstname" maxlength="25"
                           placeholder="<fmt:message key="label.registration.first_name"/>*" required/>
                </div>
                <div>
                    <input class="userdata" id="lname" type="text" name="lastname" required="" maxlength="25"
